if (game:GetService("CoreGui")):FindFirstChild("AlterHub") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).AlterHub:Destroy();
...
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("AlterHub")).Enabled = not (game.CoreGui:FindFirstChild("AlterHub")).Enabled;
end);
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		...
		if not isfolder("AlterHub/Library/") then
			makefolder("AlterHub/Library/");
		end;
		if not isfile(("AlterHub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("AlterHub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("AlterHub/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("AlterHub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("AlterHub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	local AlterHub = Instance.new("ScreenGui");
	AlterHub.Name = "AlterHub";
	AlterHub.Parent = game.CoreGui;
	AlterHub.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = AlterHub;
